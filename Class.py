...
class Bird:
    ...
    def __init__(self):
        self.birdStatus = [pygame.image.load('image/Bird.png').convert_alpha(),
                           pygame.image.load('image/Bird.png').convert_alpha(),
                           pygame.image.load('image/Bird.png').convert_alpha()]
        self.dead = False
        self.jump = False
        self.g = 2
        ...
        self.score = 0
        self.status = 0
        self.birdRect = pygame.Rect(self.x + self.size / 6, self.y + self.size / 6, self.size * 2 / 3,
                                    self.size * 2 / 3)
...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.guandao_down_Rect = pygame.Rect(self.x, self.down_guandao, self.guandao_down.get_width(),
                                             self.size_guandao[1])
        self.guankou_up_Rect = pygame.Rect(self.x - 12, self.up_guankou - 5, self.guankou_up.get_width(),
                                           self.size_guankou - 5)
        self.guankou_down_Rect = pygame.Rect(self.x - 12, self.down_guankou + 10, self.guankou_down.get_width(),
                                             self.size_guankou + 10)
...
class Monster:
    def __init__(self):
        ...
        self.Rect = pygame.Rect(self.x - self.size[0] / 2.5, self.y - self.size[1] / 2.5, self.size[0] * 0.8,
                                self.size[1] * 0.8)
